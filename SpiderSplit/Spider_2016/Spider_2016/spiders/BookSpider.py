...
import scrapy
import pymysql
from Spider_2016.items import Spider2016Item
...
class get_url_list():
	...
	url_list = cur.execute("SELECT * FROM paperbookurl WHERE url LIKE '%2016%' UNION SELECT * FROM ebookurl WHERE url LIKE '%2016%'")
