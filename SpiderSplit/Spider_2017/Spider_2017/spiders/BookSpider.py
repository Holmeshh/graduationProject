...
import scrapy
import pymysql
from Spider_2017.items import Spider2017Item
import Spider_2017.settings as msg
class get_url_list():
	...
	url_list = cur.execute("SELECT * FROM paperbookurl WHERE url LIKE '%2017%' UNION SELECT * FROM ebookurl WHERE url LIKE '%2017%'")
