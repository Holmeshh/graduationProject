...
import scrapy
import pymysql
from Spider_2018.items import Spider2018Item
import Spider_2018.settings as msg
class get_url_list():
	...
	url_list = cur.execute("SELECT * FROM paperbookurl WHERE url LIKE '%2018%' UNION SELECT * FROM ebookurl WHERE url LIKE '%2018%'")
